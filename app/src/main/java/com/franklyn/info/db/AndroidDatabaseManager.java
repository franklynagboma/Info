...
import com.franklyn.info.db.provider.InfoHelper;
...
// all global variables
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//in the below line Change the text 'yourCustomSqlHelper' with your custom sqlitehelper class name
		dbm = new InfoHelper(AndroidDatabaseManager.this);
		...
		setContentView(mainscrollview);
                ...
                //the first row of layout which has a text view_up and spinner
		...
		ArrayList<Cursor> alc ;
         	 ...
         	 //the horizontal scroll view_up for table if the table content doesnot fit into screen
		...
		//A button which generates a text view_up from which user can write custome queries
		...
		//the text view_up at the bottom of the screen which displays error or success messages after a query is executed
		...
		//when user enter a custom query in text view_up and clicks on submit query button
