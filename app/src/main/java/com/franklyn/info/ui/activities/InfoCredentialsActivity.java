 ...
 */
public class InfoCredentialsActivity extends AppCompatActivity
        implements EmailOptionalFragment.ChangeEmail,
                    LoginFragment.logIn, CompleteSignUpFragment.LoadItems,
                    RegistrationFragment.Registered, DetailsFragment.Transfer{

    private String logTag = InfoCredentialsActivity.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //Bind layout to view.
        setContentView(R.layout.activity_info_credential);
     ...
     /*   toolbar = (Toolbar) findViewById(R.id.toolbar);
        ...
        (findViewById(R.id.db)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                finish();
                startActivity(new Intent(InfoCredentialsActivity.this,
    ...
    @Override
    public void transferClass(boolean value) {
        if(value)
            startActivity(new Intent(InfoCredentialsActivity.this, InfoDetailActivity.class));
    }
